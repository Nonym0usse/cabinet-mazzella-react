            ...
            <section class="bg-white py-12 px-4 md:px-0">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center">
                        ...
                        <h1 className="text-5xl font-bold text-teal-600">Un rendez-vous? Une <span className='text-red-400'>question?</span></h1>
                    ...
                    <div class="mt-12 grid grid-cols-1 lg:grid-cols-1 gap-8">
                        ...
                        <div class="bg-gray-100 p-6 rounded-lg shadow-lg">
                            <ul class="space-y-4 text-gray-700">
                                <li>
                                    <strong className="text-teal-600">Adresse :</strong> <br />
                                    3 Rue des Mimosas, 06400 Cannes
                                </li>
                                <li>
                                    <strong className="text-teal-600">Téléphone :</strong> <br />
                                    <a href="tel:+0493391000" class="text-red-400 hover:text-red-500">04 93 39 10 00</a>
                                </li>
                                <li>
                                    <strong className="text-teal-600">Email :</strong> <br />
                                    <a href="mailto:selarlmdb@gmail.com" class="text-red-400 hover:text-red-500">selarlmdb@gmail.com</a>
                                </li>
                                <li>
                                    <strong className="text-teal-600">Horaires d'ouverture :</strong> <br />
                                    <p>
