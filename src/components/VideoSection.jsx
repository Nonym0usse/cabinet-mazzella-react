        ...
        <div className="relative h-[60vh] md:h-[60vh] overflow-hidden"> {/* Adjust heights for responsiveness */}
            ...
            <div className="container relative z-10 mx-auto h-full flex flex-col items-start justify-center px-4 md:px-8">
                ...
                <div className='bg-red-400 p-1.5 rounded ml-10 sm:ml-0 md:ml-0'>
                    <h6 className="text-white text-[14px] md:text-base text-center font-extralight tracking-wide">
                ...
                <div className='bg-slate-50 p-2 rounded mt-2 font-catamaran font-semibold md:pl-2 ml-10 md:ml-0'>
                    <h1 className="text-teal-600 text-[20px] text-left sm:text-left md:text-5xl sm:text-5xl lg:text-5xl md:text-left">
                        {title}
                    </h1>
                </div>
